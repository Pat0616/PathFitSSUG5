...
import LacupantoImg from '../../assets/memberPortraits/Lacupanto.webp'
import SSULogo from '../../assets/ssuLogoClear.svg'


function LacupantoReflectionPage()
{
  ...
  <div className="rpind-card">
    ...
    <div className="rpind-reflection">
      ...
      <p>
       These past few weeks flew by so fast, every week I did my exercise and documented some of them. At first it wasn't that difficult for me because I have been training and exercising everyday since I started my fitness journey back in 2020, but I felt that I have been much more active and happier lately, I did not lose any weight though because im maintaining my weight but the exercises were a good addition to my routine, I became more stronger I think. It was also kinda fun doing exercises, knowing that I will be much healthier by doing this everyday and it can help me avoid sickness.
      </p>
...
export default LacupantoReflectionPage