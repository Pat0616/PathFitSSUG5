...
function FerreraseflectionPage()
{
  ...
  <div className="rpind-card">
    ...
    <div className="rpind-reflection">
      ...
      <p>
        In the past few weeks that we did the exercise training program, some of those were familiar to mine because I did those when I was doing my home workout. I can really say that it was easy yet very helpful for my health well being. Even though the exercise training program is officially done, I will still use what I learned in that exercise training program to improve my home workout.
      </p>
...
export default FerreraseflectionPage;