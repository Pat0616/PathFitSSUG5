...
import Despabiladeras from '../../assets/memberPortraits/Despibeladeras.webp'
    ...
    return(
        ...
        <div className='intropage'>
            <div className='hero'>
                ...
                <div className="rpgs-grid">

                <Link to='/studentreflections/1' className="rpgs-card">
                    <div className="rpgs-image">
                    <img src={DellosaImg} alt="Dellosa, Rodel C." />
                    </div>

                    <div className="rpgs-details">
                ...
                <Link to='/studentreflections/2' className="rpgs-card">
                    <div className="rpgs-image">
                ...
                <Link to='/studentreflections/3' className="rpgs-card">
                    <div className="rpgs-image">
                ...
                <Link to='/studentreflections/4' className="rpgs-card">
                    <div className="rpgs-image">
                ...
                <Link to='/studentreflections/5' className="rpgs-card">
                    <div className="rpgs-image">
                ...
                <Link to='/studentreflections/6' className="rpgs-card">
                    <div className="rpgs-image">
                ...
                <Link to='/studentreflections/7' className="rpgs-card">
                    <div className="rpgs-image">
